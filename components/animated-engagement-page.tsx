                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-lg font-semibold text-foreground">September 11, 2026</p>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-lg font-semibold text-foreground">Boulevard Palace - Kafr El-Sheikh</p>
                    </div>
                  </div>
                </motion.div>
              </motion.div>
                  ...
                  <div className="relative z-10">
                    ...
                    >
                      <div className="flex items-center gap-4 text-lg">
                        ...
                        <span className="text-xl font-medium text-foreground">September 11, 2026</span>
                      </div>
                      ...
                      <div className="flex items-center gap-4 text-lg">
                        ...
                        <span className="text-xl font-medium text-foreground">9:00 PM</span>
                      </div>
                    </motion.div>
                  </div>
                </div>
